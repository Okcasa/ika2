...
<body>
  ...
  <script>
    ...
    const MIN_QTY = 5;
    const PACKS = {
      p30: { priceId: "pri_01khz4yjp25njyd9hw0dvs2aj0", leads: 30, total: 3.6, meta: "30 lead pack · one-time" },
      p90: { priceId: "pri_01khz4yt8pwmzjzmzwy08g0b5z", leads: 90, total: 10.8, meta: "90 lead pack · one-time" },
      p180: { priceId: "pri_01khz4ytg9sy96hxyhxe1fxrvh", leads: 180, total: 21.6, meta: "180 lead pack · one-time" },
      p280: { priceId: "pri_01khz4ytcgm7f9xmfbjebeb747", leads: 280, total: 33.6, meta: "280 lead pack · one-time" },
