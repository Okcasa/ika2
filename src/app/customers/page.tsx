    ...
    <div className="p-8 space-y-8 app-shell-bg app-shell-text min-h-screen select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6" data-tutorial-id="leads-stats">
        <Card className="bg-white p-8 rounded-[2.5rem] border-none shadow-sm relative overflow-hidden group transition-all hover:shadow-md">
          ...
          <div className="flex items-center mt-6 text-[11px] font-black gap-2">
            <span className="bg-blue-50 text-blue-600 px-6 py-3 rounded-2xl uppercase tracking-widest text-[12px] leading-none">
        ...
        <Card className="bg-white p-8 rounded-[2.5rem] border-none shadow-sm relative overflow-hidden group transition-all hover:shadow-md">
          ...
          <div className="flex flex-col gap-2 mt-6">
            <div className="text-[12px] leading-none font-black text-emerald-600 bg-emerald-50 w-fit px-6 py-3 rounded-2xl uppercase tracking-widest">
              High intent leads
            </div>
            <div className="text-[12px] leading-none font-black text-stone-500 bg-stone-100 w-fit px-6 py-3 rounded-2xl uppercase tracking-widest">
        ...
        <Card className="bg-white p-8 rounded-[2.5rem] border-none shadow-sm relative overflow-hidden group transition-all hover:shadow-md">
          ...
          <div className="flex items-center mt-6 text-[12px] leading-none font-black text-stone-900 bg-stone-100 w-fit px-6 py-3 rounded-2xl uppercase tracking-widest">
