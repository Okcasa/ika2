  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto app-shell-text h-screen overflow-y-auto select-none flex flex-col gap-8">
      <style jsx global>{`
        ...
        .keycap-choice-active {
          box-shadow:
            inset -8px 0 8px rgba(0, 0, 0, 0.18),
            inset 0 -8px 8px rgba(0, 0, 0, 0.28),
            0 0 0 2px rgba(124, 58, 237, 0.75),
            0 0 0 5px rgba(167, 139, 250, 0.22),
            10px 20px 25px rgba(0, 0, 0, 0.42);
        }
        .keycap-choice:active {
          box-shadow:
            inset -7px 0 7px rgba(0, 0, 0, 0.22),
            inset 0 -7px 7px rgba(0, 0, 0, 0.26),
            0 0 0 2px rgba(124, 58, 237, 0.85),
            0 0 0 6px rgba(167, 139, 250, 0.28),
            4px 9px 14px rgba(0, 0, 0, 0.4);
        }
      `}</style>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-8 items-end">
                  <div className="space-y-7">
                    <div className="space-y-3">
                      <p className="text-xs font-black uppercase tracking-wider text-stone-500">Select Leads</p>
                      <div className="flex flex-wrap gap-3 max-w-md">
                        {[30, 90, 180, 280].map((n) => (
                          <Button
                            ...
                            variant="outline"
                            className={cn(
                              "keycap-button keycap-choice border-0 bg-transparent hover:bg-transparent",
                              quantities.standard === n && "keycap-choice-active"
                            )}
                            onClick={() => handleQuantityChange('standard', n)}
                          >
                            <span className="text-[14px] font-black tracking-widest uppercase text-[#f2f2f2]">
                              {n} Leads
                            </span>
                          </Button>
                        ))}
